...
exports.forceUpdateSticker = (context, currentSticker) => __awaiter(void 0, void 0, void 0, function* () { return _attemptToUpdateSticker(context, currentSticker, forceUpdateAsset); });
exports.attemptToUpdateSticker = (context, currentSticker) => __awaiter(void 0, void 0, void 0, function* () { return _attemptToUpdateSticker(context, currentSticker, attemptToUpdateAsset); });
const _attemptToUpdateSticker = (context, currentSticker, assetUpdater) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const remoteBackgroundUrl = `${ENV_1.BACKGROUND_ASSETS_URL}${wallpaperPathToUrl(currentSticker)}`;
