...
function attemptToInstallAsset(context, sticker, installAsset) {
    return __awaiter(this, void 0, void 0, function* () {
...
function attemptToInstallSticker(sticker, context) {
    return __awaiter(this, void 0, void 0, function* () {
        return attemptToInstallAsset(context, sticker, () => performStickerInstall(sticker, context));
    });
}
exports.attemptToInstallSticker = attemptToInstallSticker;
function attemptToInstallWallpaper(sticker, context) {
    return __awaiter(this, void 0, void 0, function* () {
        return attemptToInstallAsset(context, sticker, () => performWallpaperInstall(sticker, context));
    });
}
...
function performStickerInstall(sticker, context) {
    return __awaiter(this, void 0, void 0, function* () {
        return yield StickerService_1.installStickers(sticker, context);
    });
}
function performWallpaperInstall(sticker, context) {
    return __awaiter(this, void 0, void 0, function* () {
        return yield StickerService_1.installWallPaper(sticker, context);
    });
}
...
exports.getCurrentThemeAndSticker = () => {
    ...
    const dokiThemeDefinition = DokiThemeDefinitions_1.default.find((dokiDefinition) => dokiDefinition.themeDefinition.information.id === currentThemeId) || DokiThemeDefinitions_1.default[0];
...
function isCultured(context, sticker) {
    return (sticker.name.indexOf("rias_onyx_spicy.png") > -1 &&
