...
complete -c systemd-cgls -l xattr -d 'Controls whether to include information about extended attributes of the list…'
complete -c systemd-cgls -l cgroup-id -d 'Controls whether to include the numeric ID of the listed control groups in th…'
