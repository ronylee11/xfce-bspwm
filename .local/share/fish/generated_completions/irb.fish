...
complete -c irb -l extra-doc-dir -d 'Add an extra doc dir for the doc dialog.  Pp Pp'
complete -c irb -l echo -d 'Show result (default).  Pp'
complete -c irb -l noecho -d 'Don\'t show result.  Pp Pp'
complete -c irb -l echo-on-assignment -d 'Show result on assignment.  Pp'
complete -c irb -l noecho-on-assignment -d 'Don\'t show result on assignment.  Pp'
complete -c irb -l truncate-echo-on-assignment -d 'Show truncated result on assignment (default).  Pp Pp'
complete -c irb -l colorize -d 'Use colorization.  Pp'
complete -c irb -l nocolorize -d 'Don\'t use colorization.  Pp Pp'
complete -c irb -l autocomplete -d 'Use autocompletion.  Pp'
complete -c irb -l noautocomplete -d 'Don\'t use autocompletion.  Pp Pp'
