...
complete -c git-checkout -s b -d 'Create a new branch named <new-branch> and start it at <start-point>; see git…'
complete -c git-checkout -s B -d 'Creates the branch <new-branch> and start it at <start-point>; if it already …'
